function [filtered_localisations] = filter_localisations(localisations,view_mask, dx_range, dy_range)

%% FILTER_LOCALISATIONS_BY_VIEW: uses an array mask to remove views from LF2 data
% localisations: list in form (frame, x', y', u, v, dx, dy, ampl, flag)
% view_mask: 2D binary array indicating which views to keep. Must be odd in
% size
...
filtered_localisations = localisations;
